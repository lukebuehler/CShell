...
namespace CShell
{
    ...
    {
        public WorkspaceOpeningEventArgs(Workspace ws)
        {
            Workspace = ws;
        }
    ...
    {
        public WorkspaceOpenedEventArgs(Workspace ws)
        {
            Workspace = ws;
        }
        public Workspace Workspace { get; private set; }
    ...
    public class WorkspaceClosingEventArgs : EventArgs
    {
        public WorkspaceClosingEventArgs(Workspace ws)
        {
            Workspace = ws;
        }
        public Workspace Workspace { get; private set; }
